...
const ProductAdd = () => {
  ...
  const resetTypesSelector = () => {
    ...
    //to-do: also reset custom attributes values
  }
  ...
  const insertNewProduct = async () => {
    ...
    if(formIsValid === true){
      ...
      const resp = await axios.post('http://127.0.0.1/scandiweb-backend/index.php/product/add-product', JSON.stringify(payload));
